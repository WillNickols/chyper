...
#' @title Mean of conditional hypergeometric distributions
#'
#' @description Calculates the mean of a conditional hypergeometric distribution: the distribution of how many items are in the overlap of all samples when samples of arbitrary size are each taken without replacement from populations of arbitrary size.
#'
#' @param s an integer representing the size of the intersecting population
#' @param n a vector of integers representing the sizes of each non-intersecting population
#' @param m a vector of integers representing the sample sizes
#'
#' @return The mean of the conditional hypergeometric distribution specified
#'
#' @examples meanchyper(10, c(12,13,14), c(7,8,9))
#'
#' @export meanchyper

# This function calculates the mean of a conditional hypergeometric
# distribution using Adam's law as explained in the Guide.
meanchyper <- function(s, n, m) {
  prod(m) / prod(n + s) * s
}
...
#' @title Method of moments estimator for a unique population size in conditional hypergeometric distributions
#'
#' @description Calculates the MOM estimator of a unique population size in a conditional hypergeometric distribution: the distribution of how many items are in the overlap of all samples when samples of arbitrary size are each taken without replacement from populations of arbitrary size.
#'
#' @param population the index of the unique population to estimate
#' @param k the observed overlaps
#' @param s an integer representing the size of the intersecting population
...
#' @param m a vector of integers representing the sample sizes
#'
#' @return The method of moments estimator of the unknown unique population size
#'
#' @examples momN(1, c(0,0,1,1,0,2,0), 8, c(0,13,14), c(7,8,9))
#'
#' @export momN

# This function finds the method of moments estimator of an unknown unique
# population size given the index of the unknown population size, an input
# vector of sample overlaps (integers), the overlapping population size, a
# vector of unique population sizes (a vector of integers where the unknown
# value should be any placeholder integer), and the sample sizes from each
...
momN <- function(population, k, s, n, m) {
  # Check that inputs are valid
  ...
  # Return the method of moments estimator as described in the Guide
  return (prod(m) / prod(n[-population] + s) * s/xbar - s)
}

#' @title Method of moments estimator for sample size in conditional hypergeometric distributions
#'
#' @description Calculates the MOM estimator of a sample size in a conditional hypergeometric distribution: the distribution of how many items are in the overlap of all samples when samples of arbitrary size are each taken without replacement from populations of arbitrary size.
#'
#' @param population the index of the unknown sample size
#' @param k the observed overlaps
#' @param s an integer representing the size of the intersecting population
...
#' @param m a vector of integers representing the sample sizes where the value of the unknown sample size should be any integer as a placeholder
#'
#' @return The method of moments estimator of the unknown sample size
#'
#' @examples momM(1, c(0,0,1,1,0,2,0), 8, c(12,13,14), c(0,8,9))
#'
#' @export momM

# This function finds the method of moments estimator of an unknown sample
# size given the index of the unknown sample size, an input vector of sample
# overlaps (integers), the overlapping population size, a vector of unique
# population sizes (integers), and the sample sizes from each population (a
# vector of integers where the unknown value should be any placeholder integer).

momM <- function(population, k, s, n, m) {
  # Check that inputs are valid
  ...
  # Return the method of moments estimator as described in the Guide
  return (xbar * (prod(n + s)) / (prod(m[-population]) * s))
}
